...
#Quatrième modèle de prédiction utilisant les effectifs selon les spécialités des lycées pour prédire le nombre d'élèves issus du même lycée
...
lycee_s = pd.read_csv("1 - Sélection des données\Jeux créés\lycee_s", sep=";")
...
#Meilleur score évaluation : 0.08164137378232957
#Meilleur score : 0.039966162936109106
#Le modèle de prédiction est presque aléatoire. 
#On garde quelques variables ; étant donné le nombre de variables du jeu, on peut penser que certaines sont pertinentes, mais que beaucoup ne le sont pas ce qui perturbe le RandomForest.