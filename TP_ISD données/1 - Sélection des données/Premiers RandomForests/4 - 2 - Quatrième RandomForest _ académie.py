...
#Quatrième modèle de prédiction utilisant les effectifs selon les spécialités des lycées pour prédire le nombre d'élèves issus de la même académie que le lycée de la formation
...
#Meilleur score évaluation : 0.2725386225898146
#Meilleur score : 0.2158525452804474
#Le modèle n'est pas satisfaisant mais pas complètement aléatoire. On sélectionne les meilleures variables avec test par permutation.