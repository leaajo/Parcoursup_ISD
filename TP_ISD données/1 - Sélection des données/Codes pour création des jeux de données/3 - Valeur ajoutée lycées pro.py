import pandas as pd 
val_aj_pro = pd.read_csv(r"1 - Sélection des données\Jeux de données\fr-en-indicateurs-de-resultat-des-lycees-denseignement-professionnels.csv", sep=";")
...
val_aj_pro.info()
val_aj_pro.to_csv(r"1 - Sélection des données\Jeux créés\val_aj_pro", sep=";")