import pandas as pd 
langues = pd.read_csv(r"1 - Sélection des données\Jeux de données\fr-en-lycee_pro-effectifs-niveau-sexe-lv.csv", sep=";")
...
langues_pro.to_csv(r"1 - Sélection des données\Jeux créés\langues_pro", sep=";")