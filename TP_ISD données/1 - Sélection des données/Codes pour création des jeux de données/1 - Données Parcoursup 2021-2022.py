...
import pandas as pd
lycee_df = pd.read_csv(r'1 - Sélection des données\Jeux de données\fr-esr-parcoursup_2022.csv', sep=";")
...
lycee_df2 = lycee_df2.to_csv(r'1 - Sélection des données\Jeux créés\lycee_df', sep=";")