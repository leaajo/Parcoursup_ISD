...
lycee_df = pd.read_csv(r"2 - Classification supervisée après sélection\Jeux créés\tableau_pred_eleves_lycee", sep=";")
...
epsilon = 4.5 #Déterminé par le graphique
y_pred = DBSCAN(eps=epsilon, min_samples=2).fit_predict(lycee_n)
lycee_sc["Classe DBSCAN"] = y_pred + 1

lycee_sc.to_csv(r"4 - Amélioration du modèle par clustering\Jeux créés\lycee_sc", sep=";")