import pandas as pd 
import numpy as np 
val_aj_gnle_tech = pd.read_csv('./Sélection des variables/df_inter/val_aj_gnle', sep=";")
val_aj_pro = pd.read_csv('./Sélection des variables/df_inter/val_aj_pro', sep=";")
...
val_aj.info()
val_aj.to_csv('./Sélection des variables/df_inter/val_aj', sep=";")
