import pandas as pd 
import numpy as np 
val_aj_gnle_tech = pd.read_csv(r"Sélection des données\val_aj_gnle", sep=";")
val_aj_pro = pd.read_csv(r"Sélection des données\val_aj_pro", sep=";")
...
val_aj.info()
val_aj.to_csv(r"Sélection des données\val_aj", sep=";")
