import pandas as pd 
langues = pd.read_csv(r"Sélection des données\Jeux de données\fr-en-lycee_gt-effectifs-niveau-sexe-lv.csv", sep=";")
...
langues_gt.to_csv(r"Sélection des données\langues_gt", sep=";")