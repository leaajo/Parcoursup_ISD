...
lycee_df = pd.read_csv('./Sélection des variables/df_inter/lycee_df2', sep=";")
...
langues_gt = pd.read_csv('./Sélection des variables/df_inter/langues_gt', sep=";")
langues_pro = pd.read_csv('./Sélection des variables/df_inter/langues_pro', sep=";")
...
lycee_l.info()
lycee_l.to_csv('./Sélection des variables/df_inter/lycee_l', sep=";")