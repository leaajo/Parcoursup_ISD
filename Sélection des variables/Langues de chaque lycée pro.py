import pandas as pd 
langues = pd.read_csv(r"Sélection des données\Jeux de données\fr-en-lycee_pro-effectifs-niveau-sexe-lv.csv", sep=";")
...
langues_pro.to_csv(r"Sélection des données\langues_pro", sep=";")